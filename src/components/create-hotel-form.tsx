...
export function CreateHotelForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error ?? "Error al guardar el hotel");
        return;
      }
        ...
        >
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="mb-5 flex items-center justify-between">
              <h2 className="text-base font-semibold text-zinc-900">Nuevo hotel</h2>
              <button onClick={closeModal} className="text-zinc-400 hover:text-zinc-600" aria-label="Cerrar">✕</button>
            </div>

            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <label htmlFor="hotel-name" className="text-xs font-medium text-zinc-700">
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="hotel-link" className="text-xs font-medium text-zinc-700">Enlace (Booking, etc.)</label>
                <input
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  <label htmlFor="checkInDate" className="text-xs font-medium text-zinc-700">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="checkOutDate" className="text-xs font-medium text-zinc-700">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  <label htmlFor="pricePerNight" className="text-xs font-medium text-zinc-700">Precio por noche</label>
                  <input
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="hotel-currency" className="text-xs font-medium text-zinc-700">Moneda</label>
                  <select
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="hotel-notes" className="text-xs font-medium text-zinc-700">Notas</label>
                <textarea
